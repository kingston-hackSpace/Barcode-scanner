...
<p>The Barcode scanner scans barcode images and converts this in a stream of data over a USB connection. The scanner has a number of modes allowing you send the data in different formats. </p>
